                ...
                <form action="registrarDatos">
                    ...
                    <div class="row g-3 mb-3 justify-content-center">
                        <div class="col-12 col-md-6">
                            <input class="form-control" type="text" name="campoNombre" id="campoNombre" placeholder="Nombre">
                        </div>
                        <div class="col-12 col-md-6">
                            <input class="col-12 col-md-6 form-control" type="text" name="campoApellido" id="campoApellido" placeholder="Apellido">
                        </div>
                    </div>
                    <!-- Correo -->
                    <div class="row g-3 mb-2">
                        <div class="col-12">
                            <input type="email" class="col-12 form-control" name="campoEmail" id="campoEmail" placeholder="correo@electronico.com">
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-12 col-md-6">
                            ...
                            <input id="campoCantidad" type="number" min="1" value="1" class="col-12 col-md-6 form-control" name="campoCantidad" placeholder="cantidad">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <select id="campoCategoria" class="col-12 col-md-6 form-control" name="campoCategoria">
